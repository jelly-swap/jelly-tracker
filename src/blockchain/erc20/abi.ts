export default [
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'string', name: 'outputNetwork', type: 'string' },
            { indexed: false, internalType: 'string', name: 'outputAddress', type: 'string' },
        ],
        name: 'NewContract',
        type: 'event',
    },
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'string', name: 'outputNetwork', type: 'string' },
            { internalType: 'string', name: 'outputAddress', type: 'string' },
        ],
        payable: false,
        stateMutability: 'view',
        type: 'function',
